...
# Данный кусок закомментирован в связи с изменение логики авторизации (он не будет работать)
# @allure.feature('Проверки валидации поля EMAIL при авторизации')
# class TestAuthEmailFld:
#     @allure.story('Позитивные проверки валидации email при авторизации по кол-ву симовлов')
#     @pytest.mark.parametrize('params',
#                              dtp.EMAIL_FLD_LEN[0],
#                              ids=dtp.EMAIL_FLD_LEN[1])
#     def test_auth_email_len_valid_possit(self, enter_auth, params):
#         """Позитивные проверки валидации поля Email при авторизации по кол-ву символов"""
#         # enter_auth.screen_shot()
#
#         enter_auth.fill_the_field('AUTH_EMAIL_FLD_ID', params['INPUT'], 'ID')
#         err_mess = str(enter_auth.get_elem_obj_or_ex('ER_MESS_AUTH_EMAIL_XP', 'XPATH').get_attribute('textContent'))
#         enter_auth.get_elem_obj_or_ex('AUTH_EMAIL_FLD_ID', 'ID').send_keys(Keys.COMMAND + 'a')
#         enter_auth.get_elem_obj_or_ex('AUTH_EMAIL_FLD_ID', 'ID').send_keys(Keys.BACKSPACE)
#         assert err_mess == '', 'При вводе валидных данных появляется ошибка'
#
#     @allure.story('Позитивные проверки валидации email при авторизации по типу вводимых симовлов')
#     @pytest.mark.parametrize('params',
#                              dtp.EMAIL_FLD_SYMB[0],
#                              ids=dtp.EMAIL_FLD_SYMB[1])
#     def test_auth_email_symb_valid_possit(self, enter_auth, params):
#         """Позитивные проверки валидации поля Email при авторизации по типу вводимых символов"""
#         enter_auth.fill_the_field('AUTH_EMAIL_FLD_ID', params['INPUT'], 'ID')
#         err_mess = str(enter_auth.get_elem_obj_or_ex('ER_MESS_AUTH_EMAIL_XP', 'XPATH').get_attribute('textContent'))
#         enter_auth.get_elem_obj_or_ex('AUTH_EMAIL_FLD_ID', 'ID').send_keys(Keys.COMMAND + 'a')
#         enter_auth.get_elem_obj_or_ex('AUTH_EMAIL_FLD_ID', 'ID').send_keys(Keys.BACKSPACE)
...
#
#     @allure.story('Негативные проверки валидации email при авторизации по минимальному кол-ву символов')
#     @pytest.mark.parametrize('params',
#                              dtn.EMAIL_FLD_MIN_LEN[0],
#                              ids=dtn.EMAIL_FLD_MIN_LEN[1])
#     def test_auth_email_min_len_negot(self, enter_auth, params):
#         """Негативные проверки валидации поля Email при авторизации по минимальному кол-ву символов"""
#         enter_auth.fill_the_field('AUTH_EMAIL_FLD_ID', params['INPUT'], 'ID')
#         err_mess = str(enter_auth.get_elem_obj_or_ex('ER_MESS_AUTH_EMAIL_XP', 'XPATH').get_attribute('textContent'))
#         enter_auth.get_elem_obj_or_ex('AUTH_EMAIL_FLD_ID', 'ID').send_keys(Keys.COMMAND + 'a')
#         enter_auth.get_elem_obj_or_ex('AUTH_EMAIL_FLD_ID', 'ID').send_keys(Keys.BACKSPACE)
...
#             (f'Текст ошибки не соответствует требованиям, expected mess: "В поле должно быть минимум 6 символов",'
#              f'fact mess: "{err_mess}"')
#
#     @allure.story('Негативные проверки валидации email при авторизации по максимальному кол-ву символов')
#     @pytest.mark.parametrize('params',
#                              dtn.EMAIL_FLD_MAX_LEN[0],
#                              ids=dtn.EMAIL_FLD_MAX_LEN[1])
#     def test_auth_email_max_len_negot(self, enter_auth, params):
#         """Негативные проверки валидации поля Email при авторизации по максимальному кол-ву символов"""
#         enter_auth.fill_the_field('AUTH_EMAIL_FLD_ID',
#                                      params['INPUT'],
#                                      'ID')
#         field_fact_data = str(enter_auth.get_elem_obj_or_ex('AUTH_EMAIL_FLD_ID', 'ID').get_attribute('value'))
#         enter_auth.get_elem_obj_or_ex('AUTH_EMAIL_FLD_ID', 'ID').send_keys(Keys.COMMAND + 'a')
#         enter_auth.get_elem_obj_or_ex('AUTH_EMAIL_FLD_ID', 'ID').send_keys(Keys.BACKSPACE)
#
#         assert field_fact_data == str(params['INPUT'])[0:70], 'Можно ввести более 70 символов'
#
#     @allure.story('Негативные проверки валидации email при авторизации по маске')
#     @pytest.mark.parametrize('params',
#                              dtn.EMAIL_FLD_MASK[0],
#                              ids=dtn.EMAIL_FLD_MASK[1])
#     def test_auth_email_mask_negot(self, enter_auth, params):
#         """Негативные проверки валидации поля Email при авторизации по маске"""
#         enter_auth.fill_the_field('AUTH_EMAIL_FLD_ID', params['INPUT'], 'ID')
#         err_mess = str(enter_auth.get_elem_obj_or_ex('ER_MESS_AUTH_EMAIL_XP', 'XPATH').get_attribute('textContent'))
#         enter_auth.get_elem_obj_or_ex('AUTH_EMAIL_FLD_ID', 'ID').send_keys(Keys.COMMAND + 'a')
#         enter_auth.get_elem_obj_or_ex('AUTH_EMAIL_FLD_ID', 'ID').send_keys(Keys.BACKSPACE)
...
#             (f'Текст ошибки не соответсnвует требованиям, expected mess: Допустимый формат почты: test@test.ru, '
#              f'fact mess: {err_mess}')
...
class TestLastNameField:
    ...
    def test_lname_len_valid_possitive(self, login_patient, params):
        ...
        # Заполняем тестируемое поле данными
        login_patient.fill_the_field('LNAME_XP',
                            params['INPUT'],
                            'XPATH')
        # получаем текст сообщения об ошибке (либо пустую строку, если сообщения нет)
        err_mess = str(login_patient.get_elem_obj_or_ex('ER_MESS_LNAME_XPATH', 'XPATH').get_attribute('textContent'))
        # очищаем поле
        login_patient.clear_field('LNAME_XP', 'XPATH')
        # login_patient.get_elem_obj_or_ex('LNAME_XP', 'XPATH').clear()
        # проверяем, что сообщения об ошибке не появляется
        assert err_mess == '', 'При вводе валидных данных появляется ошибка'
    ...
    def test_lname_space_del_possitive(self, login_patient, params):
        ...
        login_patient.clear_field('LNAME_XP', 'XPATH')
        # проверяем, что фактические введенные в поле данные сохранились без пробела
    ...
    def test_lname_text_registr_possitive(self, login_patient, params):
        ...
        field_fact_data = str(login_patient.get_elem_obj_or_ex('LNAME_XP', 'XPATH').get_attribute('value'))
        login_patient.clear_field('LNAME_XP', 'XPATH')
        # Проверяем, что после введения и снятия фокуса данные в поле сохранились в том регистре, как ввел юзер
    ...
    def test_lname_valid_min_len_negotive(self, login_patient, params):
        ...
        err_mess = str(login_patient.get_elem_obj_or_ex('ER_MESS_LNAME_XPATH', 'XPATH').get_attribute('textContent'))
        login_patient.clear_field('LNAME_XP', 'XPATH')
        # Проверяем, что текст сообщения об ошибке НЕ пустая строка
        assert err_mess != '', 'При вводе невалидного кол-ва символов ошибки не возникает '
        # Проверяем, что текст сообщения об ошибке НЕ пустая строка + проверяем сам текст
...
class TestFirstNameField:
    ...
    @pytest.mark.parametrize('params',
                            dtp.ALLNAME_FLD_LEN_POSSITIVE[0],
                            ids=dtp.ALLNAME_FLD_LEN_POSSITIVE[1])
    def test_fname_len_valid_possit(self, login_patient, params):
        """Позитивные проверки валидации имени по кол-ву символов"""
        # Заполняем поля
        login_patient.fill_the_field('FNAME_XP', params['INPUT'], 'XPATH')
        # Получаем текст ошибки или пустую строку (если ошики нет)
        err_mess = str(login_patient.get_elem_obj_or_ex('ER_MESS_FNAME_XPATH', 'XPATH').get_attribute('textContent'))
        # очищаем поле
        login_patient.clear_field('FNAME_XP', 'XPATH')
        # Проверяем, что ошибки нет (в сообщении пустая строка)
        assert err_mess == '', 'При вводе валидных данных появляется ошибка'
    ...
    @pytest.mark.parametrize('params',
                         dtp.ALLNAME_FLD_SYMB_POSSITIVE[0],
                         ids=dtp.ALLNAME_FLD_SYMB_POSSITIVE[1])
    def test_fname_symbols_valid_possit(self, login_patient, params):
    ...
    def test_fname_space_del_possit(self, login_patient, params):
        ...
        # Заполняем поле
        login_patient.fill_the_field('FNAME_XP', params['INPUT'], 'XPATH')
        # Кликаем в нейтральную область экрана, чтобы снять фокус с поля
        login_patient.click_element('LEFT_PAGE_AREA_XPATH', 'XPATH')
        # Получаем то, что сохранилось в поле после снятия фокуса
        field_fact_data = str(login_patient.get_elem_obj_or_ex('FNAME_XP', 'XPATH').get_attribute('value'))
        # Очищаем поле
        login_patient.clear_field('FNAME_XP', 'XPATH')
        # Проверяем, что пробелы не сохранились
    ...
    @pytest.mark.parametrize('params',
                         dtp.ALLNAME_FLD_TEXT_REGISTR[0],
                         ids=dtp.ALLNAME_FLD_TEXT_REGISTR[1])
    def test_fname_text_registr_possit(self, login_patient, params):
        """Позитивные проверки сохранения текста в том регистре, в каком его ввел юзер"""
        login_patient.fill_the_field('FNAME_XP', params['INPUT'], 'XPATH')
        login_patient.click_element('LEFT_PAGE_AREA_XPATH', 'XPATH')
        field_fact_data = str(login_patient.get_elem_obj_or_ex('FNAME_XP', 'XPATH').get_attribute('value'))
    ...
    @pytest.mark.parametrize('params',
                         dtn.ALLNAME_FLD_MIN_LEN[0],
                         ids=dtn.ALLNAME_FLD_MIN_LEN[1])
    def test_fname_valid_min_len_negot(self, login_patient, params):
...
class TestPatronField:
    ...
    @pytest.mark.parametrize('params',
                            dtp.ALLNAME_FLD_LEN_POSSITIVE[0],
                            ids=dtp.ALLNAME_FLD_LEN_POSSITIVE[1])
    def test_patron_len_valid_possit(self, login_patient, params):
        """Позитивные проверки валидации отчества по кол-ву символов"""
        login_patient.fill_the_field('PATRONYMIC_XP', params['INPUT'], 'XPATH')
        err_mess = str(login_patient.get_elem_obj_or_ex('ER_MESS_PATRON_XPATH', 'XPATH').get_attribute('textContent'))
        login_patient.clear_field('PATRONYMIC_XP', 'XPATH')
    ...
    @pytest.mark.parametrize('params',
                            dtp.ALLNAME_FLD_SYMB_POSSITIVE[0],
                            ids=dtp.ALLNAME_FLD_SYMB_POSSITIVE[1])
    def test_patron_symbols_valid_possit(self, login_patient, params):
    ...
    @pytest.mark.parametrize('params',
                            dtp.ALLNAME_FLD_TEXT_REGISTR[0],
                            ids=dtp.ALLNAME_FLD_TEXT_REGISTR[1])
    def test_patron_text_registr_possit(self, login_patient, params):
        """Позитивные проверки сохранения текста в том регистре, в каком его ввел юзер"""
        login_patient.fill_the_field('PATRONYMIC_XP', params['INPUT'], 'XPATH')
        login_patient.click_element('LEFT_PAGE_AREA_XPATH', 'XPATH')
        field_fact_data = str(login_patient.get_elem_obj_or_ex('PATRONYMIC_XP', 'XPATH').get_attribute('value'))
...
class TestDBirthField:
    ...
    def test_birthdate_valid_possitive(self, login_patient, params):
        ...
        # Заполняем поле
        login_patient.fill_the_field('DBIRTH_FLD_NM', params['INPUT'], 'NAME')
        # Получаем фактическое содержание поля после ввода
        date_inserted = login_patient.get_elem_obj_or_ex('DBIRTH_FLD_NM','NAME').get_attribute('value')
        # Проверяем, что фактическое содержание поля = тому, что мы вводили
        assert date_inserted == params['INPUT'], 'Ввод сохраняется не так, как ввел пользователь'
        # Получаем текст ошибки или пустую строку, если ошибки нет
        err_mess = str(login_patient.get_elem_obj_or_ex('ER_MESS_DBIRTH_XPATH', 'XPATH').get_attribute('textContent'))
        # Очищаем поле
        login_patient.clear_field('DBIRTH_FLD_NM', 'NAME')
        # Проверяем , что ошибки нет (пустая строка)
        assert err_mess == '', 'При вводе валидных данных появляется ошибка'
    ...
    def test_birthdate_eq_18(self, login_patient):
        ...
        login_patient.fill_the_field('DBIRTH_FLD_NM', birthdate_to_test, 'NAME')
        err_mess = str(login_patient.get_elem_obj_or_ex('ER_MESS_DBIRTH_XPATH', 'XPATH').get_attribute('textContent'))
        login_patient.clear_field('DBIRTH_FLD_NM', 'NAME')
...
# по новой логике поле имейл заполнять нельзя, оно заполнено по умолчанию и залочено
...
#                             dtp.EMAIL_FLD_LEN[0],
#                             ids=dtp.EMAIL_FLD_LEN[1])
#     def test_email_len_valid_possit(self, login_patient, params):
#         """Позитивные проверки валидации поля Email по кол-ву символов"""
#         # login_patient.screen_shot()
#         login_patient.fill_the_field('EMAIL_FLD_NM', params['INPUT'], 'NAME')
#         err_mess = str(login_patient.get_elem_obj_or_ex('ER_MESS_EMAIL_XPATH', 'XPATH').get_attribute('textContent'))
#         login_patient.clear_field('EMAIL_FLD_NM', 'NAME')
#         assert err_mess == '', 'При вводе валидных данных появляется ошибка'
#
...
#                              dtp.EMAIL_FLD_SYMB[0],
#                              ids=dtp.EMAIL_FLD_SYMB[1])
#     def test_email_symb_valid_possit(self, login_patient, params):
...
#                              dtn.EMAIL_FLD_MIN_LEN[0],
#                              ids=dtn.EMAIL_FLD_MIN_LEN[1])
#     def test_email_len_valid_negot(self, login_patient, params):
...
#                              dtn.EMAIL_FLD_MASK[0],
#                              ids=dtn.EMAIL_FLD_MASK[1])
#     def test_email_mask_valid_negot(self, login_patient, params):
...
class TestHeightField:
    ...
    def test_height_valid_possit(self, login_patient, params):
        """Позитивные проверки валидации поля Роста"""
        login_patient.fill_the_field('HEIGHT_FLD_NM', params['INPUT'], 'NAME')
        ...
        err_mess = str(login_patient.get_elem_obj_or_ex('ER_MESS_HEIGHT_XPATH', 'XPATH').get_attribute('textContent'))
        login_patient.clear_field('HEIGHT_FLD_NM', 'NAME')
        assert err_mess == '', 'При вводе валидных данных появляется ошибка'
    ...
    def test_height_len_valid_negot(self, login_patient, params):
    ...
    def test_height_symb_valid_negot(self, login_patient, params):
...
class TestWeightField:
    ...
    def test_weight_valid_possit(self, login_patient, params):
        """Позитивные проверки валидации поля Вес"""
        login_patient.fill_the_field('WEIGHT_FLD_NM', params['INPUT'], 'NAME')
        inserted = login_patient.get_elem_obj_or_ex('WEIGHT_FLD_NM', 'NAME').get_attribute('value')

        assert inserted == params['INPUT'], (f'Ввод НЕ сохраняется в том виде, в каком ввел юзер, expected: '
                                             f'{params["INPUT"]}, fact: {inserted}')
        err_mess = str(login_patient.get_elem_obj_or_ex('ER_MESS_WEIGHT_XPATH', 'XPATH').get_attribute('textContent'))
        login_patient.clear_field('WEIGHT_FLD_NM', 'NAME')
    ...
    def test_weight_len_valid_negot(self, login_patient, params):
        """Негативные проверки валидации поля Вес по кол-ву символов"""
        login_patient.fill_the_field('WEIGHT_FLD_NM', params['INPUT'], 'NAME')
        weight_inserted = login_patient.get_elem_obj_or_ex('WEIGHT_FLD_NM', 'NAME').get_attribute('value')
        login_patient.clear_field('WEIGHT_FLD_NM', 'NAME')
        assert weight_inserted == params['INPUT'][0:3], (f'При вводе 4-х знач числа, 4-й символ в поле должен '
                                                         f'обрезаться и в поле оставаться 3-х знач число, но expected:'
                                                         f' {params["INPUT"][0:3]}, '
                                                         f'fact: {weight_inserted} !')

    @allure.story('Негативные проверки валидации поля Вес по типу символов')
    @pytest.mark.parametrize('params',
                             dtn.WEIGHT_FLD_SYMB[0],
                             ids=dtn.WEIGHT_FLD_SYMB[1])
    def test_weight_symb_valid_negot(self, login_patient, params):
        """Негативные проверки валидации поля Вес по типу символов"""
        login_patient.fill_the_field('WEIGHT_FLD_NM', params['INPUT'], 'NAME')
        weight_inserted = login_patient.get_elem_obj_or_ex('WEIGHT_FLD_NM', 'NAME').get_attribute('value')
        login_patient.clear_field('WEIGHT_FLD_NM', 'NAME')
        assert weight_inserted == '', 'можно ввести НЕ цифры в качестве значения веса'
...
class TestAllergenField:
    ...
    def test_allergen_len_valid_possit(self, login_patient, params, open_allegry_section):
        """Позитивные проверки валидации поля Аллерген по кол-ву символов"""
        login_patient.fill_the_field('ALLRGEN_FLD_NM', params['INPUT'], 'NAME')
        ...
        err_mess = str(login_patient.get_elem_obj_or_ex('ER_MESS_ALLERGEN_XPATH', 'XPATH').get_attribute('textContent'))
        login_patient.clear_field('ALLRGEN_FLD_NM', 'NAME')
    ...
    def test_allergen_min_len_valid_negot(self, login_patient, params, open_allegry_section):
    ...
    def test_allergen_max_len_valid_negot(self, login_patient, params, open_allegry_section):
    ...
    def test_allergen_symb_valid_possit(self, login_patient, params, open_allegry_section):
...
class TestReactionField:
    ...
    def test_reaction_len_valid_possit(self, login_patient, params, open_allegry_section):
        """Позитивные проверки валидации поля Реакция по кол-ву символов"""
        login_patient.fill_the_field('REACTION_FLD_NM', params['INPUT'], 'NAME')
        ...
        err_mess = str(login_patient.get_elem_obj_or_ex('ER_MESS_REACTION_XPATH', 'XPATH').get_attribute('textContent'))
        login_patient.clear_field('REACTION_FLD_NM', 'NAME')
    ...
    def test_reaction_min_len_valid_negot(self, login_patient, params, open_allegry_section):
    ...
    def test_reaction_max_len_valid_negot(self, login_patient, params, open_allegry_section):
    ...
    @pytest.mark.parametrize('param',
                             dtp.ALLERGEN_FLD_SYMB[0],
                             ids=dtp.ALLERGEN_FLD_SYMB[1])
    def test_reaction_symb_valid_possit(self, login_patient, param, open_allegry_section):
        """Позитивные проверки валидации поля Реакция по типам символов"""
        login_patient.fill_the_field('REACTION_FLD_NM', param['INPUT'], 'NAME')
        value_inserted = login_patient.get_elem_obj_or_ex('REACTION_FLD_NM', 'NAME').get_attribute('value')
...
class TestSurgeriesField:
    ...
    def test_surgeries_len_valid_possit(self, login_patient, params, open_surgeries_section):
        """Позитивные проверки валидации поля Операции по кол-ву символов"""
        login_patient.fill_the_field('SURGERIES_FLD_NM', params['INPUT'], 'NAME')
        ...
        err_mess = str(login_patient.get_elem_obj_or_ex('ER_MESS_SURGERIES_XPATH', 'XPATH').get_attribute('textContent'))
        login_patient.clear_field('SURGERIES_FLD_NM', 'NAME')
        assert err_mess == '', 'при вводе валидного кол-ва символов появл ошибка'
    ...
    def test_surgeries_min_len_valid_negot(self, login_patient, params, open_surgeries_section):
    ...
    def test_surgeries_max_len_valid_negot(self, login_patient, params, open_surgeries_section):
    ...
    def test_surgeries_symb_valid_possit(self, login_patient, params, open_surgeries_section):
...
class TestSurgerieYearField:
    ...
    def test_surgerie_year_valid_possit(self, login_patient, params, open_surgeries_section):
        """Позитивные проверки валидации поля Год проведения (операции) по кол-ву символов"""
        login_patient.fill_the_field('SURGERIE_YEAR_FLD_NM', params['INPUT'], 'NAME')
        ...
        login_patient.clear_field('SURGERIE_YEAR_FLD_NM', 'NAME')
    ...
    def test_surger_year_len_less_then_4_digits_valid_negot(self, login_patient, params, open_surgeries_section):
    ...
    def test_surger_year_cant_input_valid_negot(self, login_patient, params, open_surgeries_section):
    ...
    def test_surger_year_len_more_than_4_digits_valid_negot(self, login_patient, params, open_surgeries_section):
    ...
    def test_surger_year_earlier_then_1950_negot(self, login_patient, params, open_surgeries_section):
...
class TestMedicationField:
    ...
    def test_medication_len_valid_possit(self, login_patient, params, open_medication_section):
        """Позитивные проверки валидации поля Препарат по кол-ву символов"""
        login_patient.fill_the_field('MEDICATION_FLD_NM', params['INPUT'], 'NAME')
        ...
        login_patient.clear_field('MEDICATION_FLD_NM', 'NAME')
        assert err_mess == '', 'при вводе валидного кол-ва символов появл ошибка'
    ...
    def test_medication_min_len_valid_negot(self, login_patient, params, open_medication_section):
    ...
    def test_medication_max_len_valid_negot(self, login_patient, params, open_medication_section):
    ...
    def test_medication_symb_valid_possit(self, login_patient, params, open_medication_section):
...
class TestDosageField:
    ...
    def test_dosage_len_valid_possit(self, login_patient, params, open_medication_section):
        """Позитивные проверки валидации поля Дозировка по кол-ву символов"""
        login_patient.fill_the_field('DOSAGE_FLD_NM', params['INPUT'], 'NAME')
        ...
        login_patient.clear_field('DOSAGE_FLD_NM', 'NAME')
        assert err_mess == '', 'при вводе валидного кол-ва символов появл ошибка'
    ...
    def test_dosage_max_len_valid_negot(self, login_patient, params, open_medication_section):
...
class TestFregOfTakingField:
    ...
    def test_freq_of_taking_len_valid_possit(self, login_patient, params, open_medication_section):
        """Позитивные проверки валидации поля Периодичность приема по кол-ву символов"""
        login_patient.fill_the_field('FREQ_OF_TAKING_FLD_NM', params['INPUT'], 'NAME')
        ...
        login_patient.clear_field('FREQ_OF_TAKING_FLD_NM', 'NAME')
        assert err_mess == '', 'при вводе валидного кол-ва символов появл ошибка'
    ...
    def test_freq_of_taking_min_len_valid_negot(self, login_patient, params, open_medication_section):
    ...
    def test_freq_of_taking_max_len_valid_negot(self, login_patient, params, open_medication_section):
    ...
    def test_freq_of_taking_symb_valid_possit(self, login_patient, params, open_medication_section):
...
class TestChronDesField:
    ...
    def test_chron_des_len_valid_possit(self, login_patient, params, open_chron_des_section):
        """Позитивные проверки валидации поля Хронические заболевания по кол-ву символов"""
        login_patient.fill_the_field('CHRON_DES_FLD_NM', params['INPUT'], 'NAME')
        ...
        login_patient.clear_field('CHRON_DES_FLD_NM', 'NAME')
        assert err_mess == '', 'при вводе валидного кол-ва символов появл ошибка'
    ...
    def test_chron_des_min_len_valid_negot(self, login_patient, params, open_chron_des_section):
    ...
    def test_chron_des_max_len_valid_negot(self, login_patient, params, open_chron_des_section):
    ...
    def test_chron_des_symb_valid_possit(self, login_patient, params, open_chron_des_section):
...
class TestChronDiscYearField:
    ...
    def test_chron_dics_year_valid_possit(self, login_patient, params, open_chron_des_section):
        """Позитивные проверки валидации поля Год обнаружения (хрон заболевания) по кол-ву символов"""
        login_patient.fill_the_field('CHRON_DISC_YEAR_FLD_NM', params['INPUT'], 'NAME')
        ...
        login_patient.clear_field('CHRON_DISC_YEAR_FLD_NM', 'NAME')
        assert err_mess == '', 'при вводе валидного года проведения операции появл ошибка'
    ...
    def test_chron_dics_year_less_than_4_digits_valid_negot(self, login_patient, params, open_chron_des_section):
    ...
    def test_chron_dics_year_cant_input_valid_negot(self, login_patient, params, open_chron_des_section):
    ...
    @allure.story('Негативные проверки валидации поля Год обнаружения (хрон заболевания) на невозможность '
                  'ввести более 4 цифр')
    @pytest.mark.parametrize('params',
                             dtn.CHRON_DISC_YEAR_LEN_MORE_THEN_FOUR_DGT_FLD[0],
                             ids=dtn.CHRON_DISC_YEAR_LEN_MORE_THEN_FOUR_DGT_FLD[1])
    def test_chron_dics_year_more_than_4_digits_valid_negot(self, login_patient, params, open_chron_des_section):
    ...
    def test_chron_dics_year_earlier_then_1950_negot(self, login_patient, params, open_chron_des_section):
        """Негативные проверки валидации поля Год обнаружения (хрон заболевания) ранее 1950 года"""
        login_patient.fill_the_field('CHRON_DISC_YEAR_FLD_NM', params['INPUT'], 'NAME')
        inserted = login_patient.get_elem_obj_or_ex('CHRON_DISC_YEAR_FLD_NM', 'NAME').get_attribute('value')
        assert inserted == params['INPUT'], 'ввод не сохраняется в том виде, как ввел пользователь'
